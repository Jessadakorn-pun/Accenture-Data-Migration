...
Attribute Upload02_SaveSheetToTXT.VB_ProcData.VB_Invoke_Func = "O\n14"
    ...
    SavePath = "C:\Users\wasurat.boonnan\OneDrive - Accenture\Desktop\LSMW prep\"  ' Modify this to your desired path
...
Attribute Upload03_ReconciledAddReviewColumnsAndFormat.VB_ProcData.VB_Invoke_Func = "R\n14"
    Dim ws As Worksheet
...
Public Sub Delta02_CopyTemplateToBlankSheet_M2()
    Dim ws As Worksheet
    ...
    MsgBox "Copy to MOCK2 complete.", vbInformation

End Sub

Public Sub Delta03_CopySheetToDelta()
...
'********************************************** please change on Delta MOCK3
        ...
        If sheetName Like "M1*" Or sheetName Like "M 1*" Or sheetName Like "m1*" Or sheetName Like "m 1*" Or sheetName Like "Mock1*" Or sheetName Like "Mock 1*" Or sheetName Like "MOCK1*" Or sheetName Like "MOCK 1*" Or sheetName Like "mock1*" Or sheetName Like "mock 1*" Or sheetName Like "Delta*" Then
            newName = "DeltaM2 " & Mid(sheetName, InStr(sheetName, " ") + 1)
        Else
            newName = "DeltaM2 " & ws1.Name
        End If
        ...
        If Not ws1 Is Nothing Then
           ...
           ActiveSheet.Name = newName
            ...
            Delta04_AddColumnforDeltaProgram
            ...
            If Not ws2 Is Nothing Then
                ...
                Range("B9:" & LetterColumn & LastRow2).Select
                Selection.Copy
                On Error Resume Next
        ...
        ActiveCell.FormulaR1C1 = "=COUNTIF(R9C6:R" & (LastRow3 + 8) & "C 6,RC[-1])"
    ...
    ActiveCell.FormulaR1C1 = _
        "=COUNTA(INDIRECT(""'""&RC[-4]&""'!$B:$B""))-COUNTA(INDIRECT(""'""&RC[-4]&""'!$B$1:$B$8""))"
    ActiveCell.Offset(0, 1).Range("A1").Select
    ActiveCell.FormulaR1C1 = _
        "=COUNTA(INDIRECT(""'""&RC[-4]&""'!$B:$B""))-COUNTA(INDIRECT(""'""&RC[-4]&""'!$B$1:$B$8""))"
    ActiveCell.Offset(0, 1).Range("A1").Select
    ...
    ' Notify user of completion
    MsgBox "Copy to Delta M2 complete.", vbInformation

End Sub

Sub Delta04_AddColumnforDeltaProgram()
Attribute Delta04_AddColumnforDeltaProgram.VB_ProcData.VB_Invoke_Func = "D\n14"
'
' Macro3 Macro
'
...
End Function
Public Sub M3Delta02_CopyTemplateToBlankSheet_M3()
    Dim ws As Worksheet
    Dim nameListSheet As Worksheet
    Dim newName As String
    Dim sheetName As String
